...
getUserInfo(handler) = getResult(handler, "https://api.coinigy.com/api/v1/userInfo")
getActivityLog(handler) = getResult(handler, "https://api.coinigy.com/api/v1/activity")
getNotifications(handler) = getResult(handler, "https://api.coinigy.com/api/v1/pushNotifications")
getAccounts(handler) = getResult(handler, "https://api.coinigy.com/api/v1/accounts")
getBalances(handler) = getResult(handler, "https://api.coinigy.com/api/v1/balances")
getBalanceHistory(handler) = getResult(handler, "https://api.coinigy.com/api/v1/balanceHistory")
getOrders(handler) = getResult(handler, "https://api.coinigy.com/api/v1/orders")
getOrderTypes(handler) = getResult(handler, "https://api.coinigy.com/api/v1/orderTypes")
getAlerts(handler) = getResult(handler, "https://api.coinigy.com/api/v1/alerts")
getUserWatchList(handler) = getResult(handler, "https://api.coinigy.com/api/v1/userWatchList")
getNewsFeed(handler) = getResult(handler, "https://api.coinigy.com/api/v1/newsFeed")
getExchanges(handler) = getResult(handler, "https://api.coinigy.com/api/v1/exchanges")
getMarkets(handler) = getResult(handler, "https://api.coinigy.com/api/v1/markets")
getTradeHistory(handler, exchange, market) = getResult(handler, "https://api.coinigy.com/api/v1/data", Dict("exchange_code" => exchange, "exchange_market" => market, "type" => "history"))
getAsks(handler, exchange, market)  = getResult(handler, "https://api.coinigy.com/api/v1/data", Dict("exchange_code" => exchange, "exchange_market" => market, "type" => "asks"))
getBids(handler, exchange, market)  = getResult(handler, "https://api.coinigy.com/api/v1/data", Dict("exchange_code" => exchange, "exchange_market" => market, "type" => "bids"))
